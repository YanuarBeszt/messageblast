...
<div class="content-wrapper">
            ...
            <form>
              ...
              <div class="card-footer">
                <div class="float-right">
                  <div class="row">
                    <button type="button" class="btn btn-primary sendSms"><i class="far fa-envelope"></i> Send</button>
                  </div>
                </div>
                <a href="<?= base_url("Message/draft")?>" class="btn btn-default"><i class="fas fa-times"></i> Discard</a>
              </div>
            </form>
          </div>
        </div>
  ...
  <script type="text/javascript" src="<?= base_url() . 'assets/js/custom/smsblast.js?' . 'random=' . uniqid() ?> "></script>
